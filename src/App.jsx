...
function App() {
  ...
  return (
    <div className="app-container">
      ...
      <main className="body">
        <Routes>
          <Route path="/" element={<Echoes onPageChange={handlePageChange} setTotalPages={setTotalPages} showBar={showBar} setVerticalScroll={setVerticalScroll} />} />
          <Route path="/echoes" element={<Echoes onPageChange={handlePageChange} setTotalPages={setTotalPages} showBar={showBar} setVerticalScroll={setVerticalScroll} />} />
          <Route path="/pagine-colori" element={<PagineColori onPageChange={handlePageChange} setTotalPages={setTotalPages} showBar={showBar} setVerticalScroll={setVerticalScroll} />} />
        </Routes>
      </main>
      <div
        className={`gallery-bar${verticalScroll ? "" : " gallery-bar--compact"}`}
